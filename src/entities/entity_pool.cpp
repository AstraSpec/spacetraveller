...
uint32_t EntityPool::create_entity(int x, int y, uint16_t atlas_x, uint16_t atlas_y) {
    return create_entity(x, y, 0, atlas_x, atlas_y);
}

uint32_t EntityPool::create_entity(int x, int y, int z, uint16_t atlas_x, uint16_t atlas_y) {
    uint32_t id = next_id++;
    uint32_t slot;
...
uint32_t EntityPool::create_entity_with_id(uint32_t id, int x, int y, int z, uint16_t atlas_x, uint16_t atlas_y) {
    uint32_t slot;
...
uint32_t EntityPool::create_player_entity(int x, int y, uint16_t atlas_x, uint16_t atlas_y) {
    return create_player_entity(x, y, 0, atlas_x, atlas_y);
}

uint32_t EntityPool::create_player_entity(int x, int y, int z, uint16_t atlas_x, uint16_t atlas_y) {
    uint32_t slot;
